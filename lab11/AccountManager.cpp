...
void AccountManager::changeUserName(const string& oldUserName, const string& newUserName) {
	...
	if (it != myAccounts.end()) {
		...
		throw Exception("changeUserName(oldUserName, newUserName",
				string("user") + oldUserName + " not present in system");
	}
}
...
void AccountManager::changePassword(const string& userName,
	...
	if ( it != myAccounts.end()) {
		...
		throw Exception("changePassword(userName, newPassword)",
				string("user") + userName + " not present in system");
	}
}
