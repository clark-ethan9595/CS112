...
//Method to test the default constructor of the Matrix Class
...
//Method to test the explicit constructor of the Matrix Class
...
//Method to test the copy constructor of the Matrix Class
...
//Method to test the overloaded assignment operator of the Matrix Class
...
//Method to test the equality operator of the Matrix Class
...
//Method to test the read subscript operator of the Matrix Class
...
//Method to test the write to subscript operator of the Matrix Class
...
//Method to run all the tests of the Matrix class
